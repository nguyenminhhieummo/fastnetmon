...
$cfg['hostname'] = "103.125.170.114"; // Juniper IP
$cfg['port'] = 880; //NETCONF Port 
$cfg['username'] = "root"; //user
$cfg['password'] = "Lvs76618!"; //pass
        ...
        try{
            ...
            if($locked){
                ...
                //Community 65535:666 = BLACKHOLE
                 $conn->load_set_configuration("set routing-options static route {$IP_ATTACK} community 18403:667 discard");   
		 $conn->commit();
            }
